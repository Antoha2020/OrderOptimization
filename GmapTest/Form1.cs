...
namespace GmapTest
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Constants.MASTERS.Add(new Master("Master2", 56.329218496084636, 38.14396228372027));
            ...
            Constants.ORDERS.Add(new Order("Заказ2", 55.505615458883995, 36.04178419148361));
            Constants.ORDERS.Add(new Order("Заказ3", 55.80838968377949, 38.99225552354677));
        }
